...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
  <a class="navbar-brand text-white" href="/../uniquedeveloper/index.php">Unique Developer</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      <li class="nav-item active">
        <a class="nav-link text-white" href="../java/display_video_list.php?course_name=java">Home <span class="sr-only">(current)</span></a>
      </li>
     <!--  <li class="nav-item">
