...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="#">Code Strike</a>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu3">Upload You File</a>
  </li>
</ul>
		<!-- Nav tabs ends -->
...
<!-- ========================================================================================================================== -->
  ...
  <div class="tab-pane container fade" id="menu2">   
	...
	<div class="container tab-pane container fade" id="menu3">
        <div class="row">
